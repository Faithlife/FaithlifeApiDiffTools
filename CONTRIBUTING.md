# Contributing to Faithlife.ApiDiffTools
...
* Clone the repository: `git clone https://github.com/Faithlife/FaithlifeApiDiffTools.git`
* `cd FaithlifeApiDiffTools`
* `./build.sh` on Unix or `.\build.ps1` on Windows
